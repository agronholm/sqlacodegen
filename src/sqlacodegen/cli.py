...
def main() -> None:
    ...
    parser.add_argument(
        "--tables", help="tables to process (comma-delimited strings or regexp, default: all)"
    )
    parser.add_argument(
        "--exclude-tables", help="tables to exclude (comma-delimited strings or regexp, default: none)"
    )
